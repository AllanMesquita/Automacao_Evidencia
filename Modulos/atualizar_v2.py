...
def popular_V17(aba, qtd_linhas, type_evid, df_mastersaf, v17):
    ...
    # tbl_rec = xl.open("C:\\Users\\allan.mesquita\\NTT\\@AM BR Services and Operations - Privado\\GESTÃO DE ESTOQUE\\002 Evidências\\tblEvidenciaRecebimento.xlsm", keep_vba=True)
    tbl_rec = xl.open("C:\\Users\\allan.mesquita\\OneDrive - NTT\\Privado\\GESTÃO DE ESTOQUE\\002 Evidências\\tblEvidenciaRecebimento.xlsm", keep_vba=True)  # Diretórios trocados após atualização no OneDrive 06.06.2022
    tbl_rec.active
    tbl_rec_sheets = tbl_rec.sheetnames
    aba_tblRec = tbl_rec[tbl_rec_sheets[0]]

    # tbl_exp = xl.open("C:\\Users\\allan.mesquita\\NTT\\@AM BR Services and Operations - Privado\\GESTÃO DE ESTOQUE\\002 Evidências\\tblEvidenciaExpedicao.xlsm", keep_vba=True)
    tbl_exp = xl.open("C:\\Users\\allan.mesquita\\OneDrive - NTT\\Privado\\GESTÃO DE ESTOQUE\\002 Evidências\\tblEvidenciaExpedicao.xlsm", keep_vba=True)  # Diretórios trocados após atualização no OneDrive 06.06.2022
    tbl_exp.active
    ...
    if type_evid == 'Recebimento':
        ...
        v17.save("C:\\Users\\allan.mesquita\\OneDrive - NTT\\Privado\\GESTÃO DE ESTOQUE\\001 Estoque\\Gestão Estoque RFID - Estoque Consolidado V17.1.xlsm")  # Diretórios trocados após atualização no OneDrive 06.06.2022
        #v17.save()
        # tbl_exp.save("C:\\Users\\allan.mesquita\\NTT\\@AM BR Services and Operations - Privado\\GESTÃO DE ESTOQUE\\002 Evidências\\tblEvidenciaExpedicao.xlsm")
        tbl_exp.save("C:\\Users\\allan.mesquita\\OneDrive - NTT\\Privado\\GESTÃO DE ESTOQUE\\002 Evidências\\tblEvidenciaExpedicao.xlsm")  # Diretórios trocados após atualização no OneDrive 06.06.2022
        # tbl_rec.save("C:\\Users\\allan.mesquita\\NTT\\@AM BR Services and Operations - Privado\\GESTÃO DE ESTOQUE\\002 Evidências\\tblEvidenciaRecebimento.xlsm")
        tbl_rec.save("C:\\Users\\allan.mesquita\\OneDrive - NTT\\Privado\\GESTÃO DE ESTOQUE\\002 Evidências\\tblEvidenciaRecebimento.xlsm")  # Diretórios trocados após atualização no OneDrive 06.06.2022
        ...
        while linha != qtd_linhas + 1:
            ...
            while linha_v17 != ultima_linha_v17:
                ...
                if str(cell_range).strip() == str(aba_v17[f'G{linha_v17}'].value).strip():
        ...
        v17.active = v17[v17_sheets[2]]
        # v17.save("C:\\Users\\allan.mesquita\\NTT\\@AM BR Services and Operations - Privado\\GESTÃO DE ESTOQUE\\001 Estoque\\Gestão Estoque RFID - Estoque Consolidado V17.1.xlsm")
        v17.save("C:\\Users\\allan.mesquita\\OneDrive - NTT\\Privado\\GESTÃO DE ESTOQUE\\001 Estoque\\Gestão Estoque RFID - Estoque Consolidado V17.1.xlsm")
        #v17.save()
        # tbl_exp.save("C:\\Users\\allan.mesquita\\NTT\\@AM BR Services and Operations - Privado\\GESTÃO DE ESTOQUE\\002 Evidências\\tblEvidenciaExpedicao.xlsm")
        tbl_exp.save("C:\\Users\\allan.mesquita\\OneDrive - NTT\\Privado\\GESTÃO DE ESTOQUE\\002 Evidências\\tblEvidenciaExpedicao.xlsm")
