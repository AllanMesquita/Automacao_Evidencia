...
tblPA = xl.open("C:\\Users\\allan.mesquita\\OneDrive - NTT\\Privado\\GESTÃO DE ESTOQUE\\100 BcoDados\\003 Evidencias\\06 Lixeira\\Testes\\02 Tabela\\tblProcessamentoAutomacoes.xlsx")
tblPA.active
...
if verificar_status is False:
	...
	try:
		...
		files = os.listdir("C:\\Users\\allan.mesquita\\OneDrive - NTT\\Privado\\GESTÃO DE ESTOQUE\\100 BcoDados\\003 Evidencias\\06 Lixeira\\Testes\\01 Processamento\\")
		...
		if len(files) > 0:
			...
			v17 = xl.open("C:\\Users\\allan.mesquita\\OneDrive - NTT\\Documents\\Projetos\\Automacao_Evidencias\\Backup V17\\Backup V17.1\\Gestão Estoque RFID - Estoque Consolidado V17.1 - 05.05.2022.xlsm", keep_vba=True)
			#v17.active
			#v17_sheets = v17.sheetnames
			#aba_v17 = v17[v17_sheets[2]]

			df_mastersaf = pd.read_excel("C:\\Users\\allan.mesquita\\OneDrive - NTT\\Privado\\INDICADORES\\Bases\\2022 - NFs Entrada Mastersaf.xlsx", sheet_name='NFsEntradaItens')
