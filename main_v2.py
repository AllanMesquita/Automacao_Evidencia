...
name_log = str('C:\\Users\\allan.mesquita\\OneDrive - NTT\\Documents\\Projetos\\Automacao_Evidencias\\Script\\Error_Log\\main_v2\\Error_Log_' + datetime.strftime(datetime.today(), '%d-%m-%Y %H.%M') + '.txt')
...
if verificar_status is False:
    ...
    try:
        ...
        files = os.listdir("C:\\Users\\allan.mesquita\\OneDrive - NTT\\Privado\\GESTÃO DE ESTOQUE\\100 BcoDados\\003 Evidencias\\01 Processamento\\")  # Diretórios trocados após atualização no OneDrive 06.06.2022
        ...
        if len(files) > 0:
            ...
            v17 = xl.open("C:\\Users\\allan.mesquita\\OneDrive - NTT\\Privado\\GESTÃO DE ESTOQUE\\001 Estoque\\Gestão Estoque RFID - Estoque Consolidado V17.1.xlsm", keep_vba=True)  # Diretórios trocados após atualização no OneDrive 06.06.2022
            #v17.active
            ...
            df_mastersaf = pd.read_excel("C:\\Users\\allan.mesquita\\OneDrive - NTT\\Privado\\INDICADORES\\Bases\\2022 á 2027 - Nfs Entrada Mastersaf.xlsx", sheet_name='Dados dos Itens')  # Diretórios trocados após atualização no OneDrive 06.06.2022
            ...
            planilha_status = xl.open("C:\\Users\\allan.mesquita\\OneDrive - NTT\\Privado\\GESTÃO DE ESTOQUE\\100 BcoDados\\003 Evidencias\\06 Lixeira\\Testes\\02 Tabela\\Controle_Status_V17.xlsx")  # Diretórios trocados após atualização no OneDrive 06.06.2022
            ...
            planilha_status.save("C:\\Users\\allan.mesquita\\OneDrive - NTT\\Privado\\GESTÃO DE ESTOQUE\\100 BcoDados\\003 Evidencias\\06 Lixeira\\Testes\\02 Tabela\\Controle_Status_V17.xlsx")  # Diretórios trocados após atualização no OneDrive 06.06.2022
